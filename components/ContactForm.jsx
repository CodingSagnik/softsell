...
export default function ContactForm() {
  ...
  return (
    <section id="contact" className="py-16 lg:py-24 bg-gray-200 dark:bg-[#1a2234] text-gray-800 dark:text-white">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {submitted ? (
            <motion.div
              ...
              className="bg-white dark:bg-[#2a3447] p-8 rounded-2xl shadow-lg text-center max-w-xl mx-auto border border-gray-300 dark:border-[#3a4560]"
            >
              <div className="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-blue-100 dark:bg-blue-500/20">
                <svg className="h-8 w-8 text-blue-600 dark:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                </svg>
              </div>
              <h3 className="mt-4 text-xl font-semibold text-gray-900 dark:text-white">Thanks for reaching out!</h3>
              <p className="mt-3 text-gray-700 dark:text-gray-300">We've received your message and will contact you shortly to discuss your software license valuation.</p>
              <div className="mt-6">
                <button
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
              className="bg-white dark:bg-[#1e263a] rounded-xl p-6 sm:p-8 shadow-md border border-gray-300 dark:border-gray-700"
            >              
              <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-6">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`pl-10 block w-full rounded-xl border-0 py-3 bg-gray-100 dark:bg-[#131a29] text-gray-900 dark:text-white placeholder-gray-600 dark:placeholder-gray-400 ${
                            errors.name ? 'ring-2 ring-red-500 border-red-500' : 'focus:ring-1 focus:ring-blue-500'
                          } shadow-sm`}
                        />
                      </div>
                      {errors.name && <p className="mt-1 text-sm text-red-500 dark:text-red-400 font-medium">{errors.name}</p>}
                    </div>
                    ...
                    <div>
                      <label htmlFor="company" className="block text-sm font-medium text-gray-800 dark:text-white mb-1">
                      ...
                      {errors.company && <p className="mt-1 text-sm text-red-500 dark:text-red-400 font-medium">{errors.company}</p>}
                    </div>
                  </div>
                  
                  <div className="space-y-6">
                    <div>
                      <label htmlFor="licenseType" className="block text-sm font-medium text-gray-800 dark:text-white mb-1">
                        License Type <span className="text-red-500 dark:text-red-400">*</span>
                      </label>
                      <div className="relative">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none z-10">
                          <svg className="h-5 w-5 text-gray-500 dark:text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                      ...
                      {errors.licenseType && <p className="mt-1 text-sm text-red-500 dark:text-red-400 font-medium">{errors.licenseType}</p>}
                    </div>
                    ...
                    <div>
                      ...
                      {errors.message && <p className="mt-1 text-sm text-red-500 dark:text-red-400 font-medium">{errors.message}</p>}
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8 flex justify-center">
                  <button
                    type="submit"
                    disabled={submitting}
                    className={`w-full md:w-auto px-8 py-3 text-base font-medium rounded-xl text-white ${
